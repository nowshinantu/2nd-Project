                    ...
                    foreach($res as $row){
                        ...
                        <tr>
                            ...
                            <!-- <td><?php echo $row['PositionDetails'] ?></td> -->
                             <td><!--<a href="editdept.php?<?php echo $row['Dept_ID'] ?>" class="btn btn-warning btn-sm">Edit</a> -->
...
{
    include_once('../db/dbconnect.php');
    $sql = "SELECT * FROM positions ORDER BY SerialNo DESC Limit 1";
    $res = getDataFromDB($sql);
    $count = count($res);
    if($count == 0){
        $id = date('Y').'-0-'.'1';
    ...
    $insert = "INSERT INTO `positions`( `PositionID`, `Dept_ID`, `Position`) VALUES ('".$id."','".$_POST["Department"]."','".$_POST["position"]."')";
