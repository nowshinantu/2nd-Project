    ...
    $res = getDataFromDB($sql);
                    foreach($res as $row){
                        ...
                        <tr>
                            ...
                            <!-- <td><?php echo $row['Dept_Details'] ?></td> -->
                            <td><a href="dptwiseemployee.php?id=<?php echo $row['Dept_ID'] ?>" class="btn btn-warning btn-sm">View</a>
                              <!-- <a href="editdept.php?id=<?php echo $row['Dept_ID'] ?>" class="btn btn-warning btn-sm">Edit</a>  -->
                              <a href="deletedept.php?<?php echo $row['Dept_ID'] ?>" class="btn btn-danger btn-sm">Delete</a></td>
                        </tr>
                        <?php
                    }
                    ?>
...
//            echo $subid;
    ...
    $insert = "INSERT INTO `departments`(`Dept_ID`, `Departtment`) VALUES ('".$id."','".$_POST["department"]."')";
